...
if test "$PHP_FIRSTEST" != "no"; then
  ...
  PHP_NEW_EXTENSION(firstest, firstest.c firstclass.c firstinterface.c firstobject.c array_example.c url_parse.c, $ext_shared,, -DZEND_ENABLE_STATIC_TSRMLS_CACHE=1)
fi
